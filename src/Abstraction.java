...
public abstract class Abstraction implements Interface{
    ...
    public void printMapValues() {
        ...
        for (Map.Entry<String, TripleValues> entry : map.entrySet()) {
            ...
            System.out.println("Key: " + key + ", Value 1: " + values.getValue1() + ", Value 2: " + values.getValue2()+ ", Value 3: " + values.getValue3());
        }
    }
    ...
    public void updateValues(String key, double newValue1, double newValue2,double newValue3) {      //update the value in the map
        if (map.containsKey(key)) {
            ...
            if (existingValues.getValue1() == newValue1 && existingValues.getValue2() == newValue2 && existingValues.getValue3() == newValue3) {
                System.out.println("Error: Values are the same. No update performed.");
            } else {
                map.put(key, new TripleValues(newValue1, newValue2,newValue3));
   ...
   public abstract void put(String key, double value1, double value2,double value3);
